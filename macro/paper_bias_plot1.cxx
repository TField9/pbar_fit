...
void paper_bias_plot1(){
    ...
    for (int i : size){ 
            ...
            TFile *f6=new TFile(Form("/data03/tianye/pbar/root/bin25_Nmc8000/unbinned_rookeyspdf1_seq0001_npi%04d.root",i),"read");
            ...
            std::vector<double>* params9 = new std::vector<double>(2);
            ...
            TTree* t6 = (TTree*)f6->Get("fitParamsTree");
            ...
            t6->SetBranchAddress("fitparams_unbinned", &params9);
            ...
            TH1D* unbinned_rookeyspdf = new TH1D("unbinned_rookeyspdf", "Unbinned RooKeysPdf", 200, 140, 280);
            ...
            TH1D* unbinned_rookeyspdf_error= new TH1D("unbinned_rookeyspdf_error", "Unbinned RooKeysPdf Error", 200, 10, 18);
            ...
            TH1D* unbinned_rookeyspdf_pull= new TH1D("Unbinned RooKeysPdf Pull", "Unbinned RooKeysPdf Pull", 200, -3, 3);
                ...
                for (int i = 0; i < nEntries; ++i) {
                    ...
                    unbinned_rookeyspdf->Fill((*params9)[0]);
                    ...
                    unbinned_rookeyspdf_error->Fill((*params9)[1]);
                    ...
                    unbinned_rookeyspdf_pull->Fill(((*params9)[0] - 200)/(*params9)[1] );
                }
                ...
                TF1 *gaussFit11 = new TF1("gaussFit11", "gaus", 100, 300);
                ...
                unbinned_rookeyspdf->Fit(gaussFit11, "Q");
                ...
                sig_yield.push_back(unbinned_rookeyspdf);
                bias.push_back(gaussFit11->GetParameter(1) / 200);
                bias_error.push_back(gaussFit11->GetParError(1) / 200);
                ...
                all_fit.push_back({gaussFit1, gaussFit2, gaussFit3, gaussFit4, gaussFit5, gaussFit6, gaussFit11,gaussFit7, gaussFit8, gaussFit9, gaussFit10});
...
//     c6->Print("/data03/tianye/pbar/macro/unbinned_fit/bin1/macro/fixneg/macro/Nmc100/pdf/bias_plot8000.pdf");
    ...
    for (size_t j = 0; j < 4; ++j) {
        ...
        if (j == 0) {
            graph2->GetYaxis()->SetRangeUser(0.98, 1.065);
            graph2->Draw("APE");
    ...
    legend2->Draw();
    c8->Update();
    c8->Print("/data03/tianye/pbar/macro/unbinned_fit/bin1/macro/fixneg/macro/Nmc100/pdf/bias_plot8000.pdf");
    ...
    legend3->Draw();
    c9->Update();
    c9->Print("/data03/tianye/pbar/macro/unbinned_fit/bin1/macro/fixneg/macro/Nmc100/pdf/bias_plot8000.pdf");
    ...
    legend4->Draw();
    c10->Update();
    c10->Print("/data03/tianye/pbar/macro/unbinned_fit/bin1/macro/fixneg/macro/Nmc100/pdf/bias_plot8000.pdf");
    ...
    legend5->Draw();
    c11->Update();
    c11->Print("/data03/tianye/pbar/macro/unbinned_fit/bin1/macro/fixneg/macro/Nmc100/pdf/bias_plot8000.pdf");
