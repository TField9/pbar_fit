...
//   TF1 func_sig = CB_Fit(hpr, pars_sig);
  ...
  hsig->Reset();
	...
	TFile *f1 = new TFile(Form("/data03/tianye/pbar/root/both_vary/toymc_bin1_seq%04d_npi%04d.root",seq,npi),"recreate");//从50到8000


for(int i=0;i<10000;++i){

      TH1D *data_pr30 = new TH1D(Form("data_pr30_%04d",i), Form("data_pr30_%04d",i), 30, -1, 3);
      //TH1D *data1_pr30 = new TH1D(Form("data1_pr30_%04d",i), Form("data1_pr30_%04d",i), 30, -1, 3);

      TH1D *data_pi30 = new TH1D(Form("data_pi30_%04d",i), Form("data_pi30_%04d",i), 30, -1, 3);
      //TH1D *data1_pi30 = new TH1D(Form("data1_pi30_%04d",i), Form("data1_pi30_%04d",i), 30, -1, 3);


      TH1D *data_neg30 = new TH1D(Form("data_neg30_%04d",i), Form("data_neg30_%04d",i), 30, -1, 3);
      //TH1D *data1_neg30 = new TH1D(Form("data1_neg30_%04d",i), Form("data1_neg30_%04d",i), 30, -1, 3);




   TString strn=Form("sigtree_%04d",i);
   TString btrn=Form("bkgtree_%04d",i);
   //TString strn1=Form("sigtree1_%04d",i);
   //TString btrn1=Form("bkgtree1_%04d",i);
   TString ntrn=Form("negtree_%04d",i);
   TString ntrn1=Form("negtree1_%04d",i);

   TTree *sigtree=new TTree(strn,strn);
   TTree *bkgtree=new TTree(btrn,btrn);
   //TTree *sigtree1=new TTree(strn1,strn1);
   //TTree *bkgtree1=new TTree(btrn1,btrn1);
   TTree *negtree=new TTree(ntrn,ntrn);
   //TTree *negtree1=new TTree(ntrn1,ntrn1);
   
   
   double pr_mass2,pi_mass2,pr1_mass2,pi1_mass2,neg_mass2,neg1_mass2;
   sigtree->Branch("pr_mass2",&pr_mass2,"pr_mass2/D");
   bkgtree->Branch("pi_mass2",&pi_mass2,"pi_mass2/D");
   //sigtree1->Branch("pr1_mass2",&pr1_mass2,"pr1_mass2/D");
   //bkgtree1->Branch("pi1_mass2",&pi1_mass2,"pi1_mass2/D");
   negtree->Branch("neg_mass2",&neg_mass2,"neg_mass2/D");
   //negtree1->Branch("neg1_mass2",&neg1_mass2,"neg1_mass2/D");
   ...
   //    pi1_mass2 = func_bkg->GetRandom();
   //    sigtree->Fill();
   //    bkgtree1->Fill();

   //    data_pr30->Fill(pr_mass2);
   //    data1_pi30->Fill(pi1_mass2);
