...
void RooFit_binned(int npr,int npi){
    ...
    TFile *fOutput = new TFile(Form("/data03/tianye/pbar/root/2d_result/binned_TFF_seq0001_npr%04d_npi%04d.root",npr,npi),"recreate");
    std::cout<<"----open file----"<<std::endl;
    std::cout<<"TFF npr="<<npr<<"npi="<<npi<<std::endl;
    ...
    for(int j=0;j<10000;j++){
        ...
        //     IWLS_HistFit(data_pr30,data_pi30,data_neg30,neg_error_bin25,nsig[0]);
        //     IWLS_HistFit(data_pr100,data_pi100,data_neg100,neg_error_bin25,nsig[1]);
        // }

        TFracFit(data_pr30,data_pi30,data_neg30,nsig[0],nsig[1]);
        ...
        if(j%100==0){
            ...
            std::cout<<nsig[0]<<std::endl;
            std::cout<<nsig[1]<<std::endl;
        }   
